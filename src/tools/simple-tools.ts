...
**MCP Tools Available:**
- \`ask-copilot\` - Execute GitHub Copilot CLI with file analysis and tool management
- \`batch-copilot\` - Batch process multiple tasks with Copilot CLI  
- \`review-copilot\` - Comprehensive code review using Copilot CLI
- \`ask\` - Execute GitHub Copilot CLI (main tool)
